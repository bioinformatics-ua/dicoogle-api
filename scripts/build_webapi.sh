...
if [ -f "$API_FILE" ]; then
  ...
  mkdir -p $WEBAPI_DIR
  npx api2html -t Googlecode -c $STATIC_DIR/images/webapi/webapi_icon_dark.png -P $STATIC_DIR/styles/webapi.css -o $WEBAPI_DIR/index.html $DICOOGLE_DIR/dicoogle_web_api.yaml
else
